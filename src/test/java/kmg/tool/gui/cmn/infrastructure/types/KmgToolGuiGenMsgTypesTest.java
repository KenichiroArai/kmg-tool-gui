...
public class KmgToolGuiGenMsgTypesTest {
     ...
     * @since 0.1.1
     */
    public KmgToolGuiGenMsgTypesTest() {
    ...
    public void testGet_normalBasicValue() {
        ...
        /* 準備 */
        final KmgToolGuiGenMsgTypes testType = KmgToolGuiGenMsgTypes.NONE;
    ...
    public void testGetDefault_normalDefaultValue() {
        ...
        /* 期待値の定義 */
        final KmgToolGuiGenMsgTypes expected = KmgToolGuiGenMsgTypes.NONE;

        /* 準備 */
        // 準備は不要

        /* テスト対象の実行 */
        final KmgToolGuiGenMsgTypes actual = KmgToolGuiGenMsgTypes.getDefault();
    ...
    public void testGetEnum_normalExistingKey() {
        ...
        /* テスト対象の実行 */
        final KmgToolGuiGenMsgTypes actual = KmgToolGuiGenMsgTypes.getEnum(key);
    ...
    public void testGetInitValue_normalInitValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolGuiGenMsgTypes actual = KmgToolGuiGenMsgTypes.getInitValue();
    ...
    public void testValues_normalAllValues() {
        ...
        /* テスト対象の実行 */
        final KmgToolGuiGenMsgTypes[] actual = KmgToolGuiGenMsgTypes.values();
